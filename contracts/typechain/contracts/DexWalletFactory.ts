...
export interface DexWalletFactoryInterface extends utils.Interface {
  functions: {
...
export interface DexWalletFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DexWalletFactoryInterface;
